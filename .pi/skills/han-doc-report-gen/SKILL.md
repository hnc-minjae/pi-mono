...
**auto 모드:**
```
mcp__hwp_auto__hwp_auto_open_document(path: ".pi/han-doc/templates/보고서.hwpx", readOnly: false)
```

**file 모드:**
```
mcp__hwp_file__hwp_file_open_document(path: ".pi/han-doc/templates/보고서.hwpx")
```
...
```
**auto 모드 — fill_click_field 도구: `mcp__hwp_auto__hwp_auto_fill_click_field`**
**file 모드 — fill_click_field 도구: `mcp__hwp_file__hwp_file_fill_click_field`**

{fill_click_field}(fieldName: "보고서_제목", value: "{생성된 제목}")
{fill_click_field}(fieldName: "보고서_목차1", value: "{섹션1 목차}")
{fill_click_field}(fieldName: "보고서_목차2", value: "{섹션2 목차}")
{fill_click_field}(fieldName: "보고서_목차3", value: "{섹션3 목차}")
{fill_click_field}(fieldName: "보고서_목차4", value: "{섹션4 목차}")
{fill_click_field}(fieldName: "보고서_목차5", value: "{섹션5 목차}")
{fill_click_field}(fieldName: "보고서_목차6", value: "{섹션6 목차}")
```
...
섹션 1~6 반복:
```
{fill_click_field}(fieldName: "보고서_소제목{N}", value: "{생성된 소제목}")
{fill_click_field}(fieldName: "보고서_본문{N}", value: "{생성된 본문}")
```
...
**auto 모드:**
```
mcp__hwp_auto__hwp_auto_save_document(path: ".pi/han-doc/output/보고서_{coreContents_sanitized}.hwpx")
mcp__hwp_auto__hwp_auto_close_document()
```

**file 모드:**
```
mcp__hwp_file__hwp_file_save_document(path: ".pi/han-doc/output/보고서_{coreContents_sanitized}.hwpx")
```
