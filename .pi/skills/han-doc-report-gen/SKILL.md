...
**auto 모드:**
```
mcp__hwp_auto__hwp_auto_open_document(filePath: ".pi/han-doc/templates/보고서.hwpx", readOnly: false)
```
...
**auto 모드:**
```
mcp__hwp_auto__hwp_auto_save_document(filePath: ".pi/han-doc/output/보고서_{coreContents_sanitized}.hwpx")
