...
user_invocable: true
argument: "[주제] — 예: /doc-draft 신규 서비스 출시 기획"
---
...
```
mcp__hwp_file__hwp_file_open_document(filePath: "templates/기획서.hwpx")
```
...
```
mcp__hwp_file__hwp_file_save_document(filePath: "output/기획서_{topic_sanitized}.hwpx")
```

완료 메시지:
> "기획서가 생성되었습니다. output/기획서_{topic_sanitized}.hwpx 파일을 확인하세요."
