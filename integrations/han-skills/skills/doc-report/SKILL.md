---
name: doc-report
description: 보고서 HWPX 문서를 자동 생성한다. 핵심내용·회사명·키워드를 입력받아 보고서 템플릿의 누름틀(제목, 목차1~6, 소제목1~6, 본문1~6)을 AI로 자동 완성한다. "보고서 작성", "보고서 생성", "보도자료", "report" 등에 반응한다.
user_invocable: true
argument: "[핵심 내용] — 예: /doc-report 한컴 AI 에이전트 플랫폼 출시"
---
...
```
mcp__hwp_file__hwp_file_open_document(filePath: "templates/보고서.hwpx")
```
...
`output/` 디렉토리가 없으면 먼저 생성한다.

```
mcp__hwp_file__hwp_file_save_document(filePath: "output/보고서_{coreContents_sanitized}.hwpx")
```

완료 메시지:
> "보고서가 생성되었습니다. output/보고서_{coreContents_sanitized}.hwpx 파일을 확인하세요."
